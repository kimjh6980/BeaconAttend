...
public class profSignIn {

    public static final String url = "http://117.16.23.140/beaconattend/ProfSignIn.php";
    ...
    public profSignIn(Context c) {
        this.context = c;
    }

    public String returnvalue;

    public void profSignIn_Asycn(final String id, final String pw, final String phonenum) {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (value.equals("Success")) { // 로그인 성공 -> 화면 전환 (비콘 받을 준비)
                    Intent BdataIntent = new Intent(MainActContext.getApplicationContext(), BeaconTransmitter.class);
